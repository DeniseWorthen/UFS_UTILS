...
The ocnice_prep program will create a MOM6 or CICE6 warmstart file at a destination resolution using a MOM6 and CICE6 restart file at a different resolution.
