!> @file
!! @brief Write the master grid file
!! @author Denise.Worthen@noaa.gov
!!
!> This module writes the main master grid file
!! @author Denise.Worthen@noaa.gov
...
module mastergrid
  ...
  public write_mastergrid

contains
  !> Write the master grid file
  !!
  !! @param[in]  fname  the name of the master grid file to write
  !!
  !! @author Denise.Worthen@noaa.gov

  subroutine write_mastergrid(fname)
    ...
    logmsg = '==> writing master grid to '//trim(fname)
    print '(a)', trim(logmsg)
  ...
  end subroutine write_mastergrid
end module mastergrid
