...
! Author Denise Worthen 2/08/2022
  ...
  program ftst_find_angq
    ...
    ! check values from model history files, mx100
    real(real_kind), dimension(ni,nj,npoles) :: cice_angle, cice_anglet
    ...
    ! CICE angle, anglet
    data ((cice_angle(i,j,1), i=1,size(cice_angle,1)), j=1,size(cice_angle,2)) /    &
    ...
    data ((cice_angle(i,j,2), i=1,size(cice_angle,1)), j=1,size(cice_angle,2)) /    &
         0.70064,      0.38859,      0.00000,      -0.38859,      -0.70064,         &
         0.90943,      0.53371,      0.00000,      -0.53371,      -0.90943,         &
         1.20822,      0.75580,      0.00000,      -0.75580,      -1.20822,         &
         1.38117,      0.89328,      0.00000,      -0.89328,      -1.38117/

    data ((cice_anglet(i,j,1), i=1,size(cice_anglet,1)), j=1,size(cice_anglet,2)) / &
    ...
    data ((cice_anglet(i,j,2), i=1,size(cice_anglet,1)), j=1,size(cice_anglet,2)) / &
         0.73204,      0.48692,       0.17198,      -0.17198,      -0.48692,        &
         0.90492,      0.63285,       0.23026,      -0.23026,      -0.63285,        &
         1.13597,      0.85126,       0.32134,      -0.32134,      -0.85126,        &
         1.34026,      1.05945,       0.41175,      -0.41175,      -1.05945/
    ...
    ! MOM6 sin_rot
    data ((mom6_sinrot(i,j,1), i=1,size(mom6_sinrot,1)), j=1,size(mom6_sinrot,2)) / &
    ...
    data ((mom6_sinrot(i,j,2), i=1,size(mom6_sinrot,1)), j=1,size(mom6_sinrot,2)) / &
         -0.67404,      -0.47460,      -0.17342,       0.17342,       0.47460, &
         -0.79354,      -0.60678,      -0.23239,       0.23239,       0.60678, &
         -0.91250,      -0.79512,      -0.32692,       0.32692,       0.79512, &
         -0.98949,      -0.97272,      -0.43486,       0.43486,       0.97272/
    ...
    ! lon Ct,Bu and latBu
    data ((lonct(i,j,1), i=1,size(lonct,1)), j=1,size(lonct,2)) /                   &
    ...
    data ((lonbu(i,j,1), i=1,size(lonbu,1)), j=1,size(lonbu,2)) /                   &
    ...
    data ((latbu(i,j,1), i=1,size(latbu,1)), j=1,size(latbu,2)) /                   &
    ...
    data ((lonct(i,j,2), i=1,size(lonct,1)), j=1,size(lonct,2)) /                   &
    ...
    data ((lonbu(i,j,2), i=1,size(lonbu,1)), j=1,size(lonbu,2)) /                   &
    ...
    data ((latbu(i,j,2), i=1,size(latbu,1)), j=1,size(latbu,2)) /                   &
         89.16921,      89.31628,      89.37292,      89.31628,      89.16921,      &
         89.31750,      89.50699,      89.58912,      89.50699,      89.31750,      &
         89.41886,      89.66093,      89.79818,      89.66093,      89.41886,      &
         89.45503,      89.72754,      90.00000,      89.72754,      89.45503/

! debug values, to see if test is working
    ! test values anglet,angle and angchk
    data ((anglet(i,j,1), i=1,size(anglet,1)), j=1,size(anglet,2)) /                &
    ...
    data ((angle(i,j,1), i=1,size(angle,1)), j=1,size(angle,2)) /                   &
         0.70064,       0.38859,       0.00000,      -0.38859,      -0.70064,       &
         0.90943,       0.53371,       0.00000,      -0.53371,      -0.90943,       &
         1.20822,       0.75580,       0.00000,      -0.75580,      -1.20822,       &
         1.38117,       0.89328,       0.00000,      -0.89328,      -1.38117/
    data ((angchk(i,j,1), i=1,size(angchk,1)), j=1,size(angchk,2)) /                &
         0.73204,       0.48692,       0.17198,      -0.17198,      -0.48692,       &
         0.90492,       0.63285,       0.23027,      -0.23027,      -0.63285,       &
         1.13597,       0.85126,       0.32134,      -0.32134,      -0.85126,       &
         1.34026,       1.05945,       0.41175,      -0.41175,      -1.05945/

    data ((anglet(i,j,2), i=1,size(anglet,1)), j=1,size(anglet,2)) /                &
         -0.73967,      -0.49452,      -0.17430,       0.17430,       0.49452,      &
         -0.91660,      -0.65200,      -0.23454,       0.23454,       0.65200,      &
         -1.14936,      -0.91921,      -0.33304,       0.33304,       0.91921,      &
         -1.42566,      -1.33669,      -0.44988,       0.44988,       1.33669/
    data ((angle(i,j,2), i=1,size(angle,1)), j=1,size(angle,2)) /                   &
         0.70064,       0.38859,       0.00000,      -0.38859,      -0.70064,       &
         0.90943,       0.53371,       0.00000,      -0.53371,      -0.90943,       &
         1.20822,       0.75580,       0.00000,      -0.75580,      -1.20822,       &
         1.38117,       0.89328,       0.00000,      -0.89328,      -1.38117/
